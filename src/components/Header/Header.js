...
const Logo = () => (
	<div className="flex-1 xl:flex-none z-10">
		<img src={logo} alt="" className="w-32 xl:w-48" />
	</div>
)
...
const Search = () => {
	...
	const SearchOverlay = () => (
		<motion.div
			...
			animate={{ opacity: 1 }}
			exit={{ opacity: 0 }}
			className="fixed bg-white left-0 md:right-8 md:left-auto w-full md:w-[550px] top-0 z-20 h-20 xl:h-24 flex items-center px-4"
		>
...
const Find = () => (
	<a href="/" className="font-bold hidden md:flex items-center gap-3 ml-8 xl:ml-4">
...
const Buttons = () => (
	<div className="gap-3 hidden xl:flex justify-center items-center h-16 ml-8 mr-auto">
...
const Header = () => {
	return (
		<StyledHeader>
			<div className="max-w-[1440px] mx-auto px-4 md:px-8 bg-white h-20 xl:h-24 flex items-center xl:justify-between relative">
				<Burger />
				<Logo />
				<Buttons />
				<Icons />
